...
| Movimiento | La gente camina a su silla con sus cuadros de paso y levanta la mano al empezar a hablar; esquiva a los demás y a la mesa, resbala por el borde del piso, los mayores van más despacio; entre turnos charlan en parejas o cruzan la plaza y vuelven. Lo lejano toma el color del aire. Nada se mueve sin motivo; `prefers-reduced-motion` apaga el caminar y la cámara |
...
| Escala | La cámara 3D copia la del cuadro (`HORIZ` en `escena.js`): el horizonte donde lo pintaron y la altura medida con una puerta (sin puerta: persona ≈ 17 % del alto en el escenario). Así la gente es del tamaño de las puertas y achica al subir la calle. Fondo nuevo = medir horizonte y una puerta |
